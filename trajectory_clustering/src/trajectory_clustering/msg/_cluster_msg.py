"""autogenerated by genmsg_py from cluster_msg.msg. Do not edit."""
import roslib.message
import struct

import std_msgs.msg

class cluster_msg(roslib.message.Message):
  _md5sum = "b27a94c469811c1a247dfd75aaf26cf3"
  _type = "trajectory_clustering/cluster_msg"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """#An array of poses representing the clusters
Header header
float64[] x
float64[] y
float64[] sigma
...
"""
  __slots__ = ['header','x','y','sigma','ID']
  _slot_types = ['Header','float64[]','float64[]','float64[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cluster_msg, self).__init__(*args, **kwds)
